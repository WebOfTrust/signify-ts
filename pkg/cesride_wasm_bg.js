...
* @returns {string}
*/
export function matter_codex_code(codex) {
    let deferred1_0;
    let deferred1_1;
    try {
...
* @returns {string}
*/
export function indexer_codex_code(codex) {
    let deferred1_0;
    let deferred1_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
export function __wbg_verfer_new(arg0) {
    const ret = Verfer.__wrap(arg0);
    return addHeapObject(ret);
};

export function __wbg_diger_new(arg0) {
