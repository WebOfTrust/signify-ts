...
describe('Credentialing', () => {
    it('Credentials', async () => {
        ...
        await credentials.state(
            'EACehJRd0wfteUAJgaTTJjMSaQqWvzeeHqAMMqxuqxU4',
        ...
        assert.equal(
            lastCall[0]!,
            url +
                '/registries/EACehJRd0wfteUAJgaTTJjMSaQqWvzeeHqAMMqxuqxU4/EBVaw6pCqfMIiZGkA6qevzRUGsxTRuZXxl6YG1neeCGF'
        );
        assert.equal(lastCall[1]!.method, 'GET');
    });
});
