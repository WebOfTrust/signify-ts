...
import { RotLabels, Saider, Salter, Serder, SignifyClient } from 'signify-ts';
...
test('vlei-verification', async function run() {
    ...
    // these come from a previous test
    const bran = 'Ak_0QIVNz4DjRarVCPduI'; //look for SIGNIFY_SECRETS
    const aidName = 'role';
